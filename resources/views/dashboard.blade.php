            ...
            >
              ...
              <div class="mt-4 flex items-end justify-between">
                <div>
                  ...
                  <span class="text-sm font-medium">Total Sources</span>
                </div>
...
<div class="flex flex-col">
  ...
  >
    ...
    <div class="flex items-center justify-center p-2.5 xl:p-5">
      <p class="font-medium text-meta-3">K5,768</p>
    </div>
  ...
  >
    ...
    <div class="flex items-center justify-center p-2.5 xl:p-5">
      <p class="font-medium text-meta-3">K4,635</p>
    </div>
  ...
  >
    ...
    <div class="flex items-center justify-center p-2.5 xl:p-5">
      <p class="font-medium text-meta-3">K4,290</p>
    </div>
  ...
  >
    ...
    <div class="flex items-center justify-center p-2.5 xl:p-5">
      <p class="font-medium text-meta-3">K3,580</p>
    </div>
  ...
  <div class="grid grid-cols-3 sm:grid-cols-5">
    ...
    <div class="flex items-center justify-center p-2.5 xl:p-5">
      <p class="font-medium text-meta-3">K2,740</p>
    </div>
