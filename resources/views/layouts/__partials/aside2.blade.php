...
>
  ...
  >
        ...
        <ul class="mb-6 flex flex-col gap-1.5">
              ...
              <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                ...
                <li>
                  <a
                    ...
                    >Analytics
                    <span class="absolute right-4 block rounded bg-primary py-1 px-2 text-xs font-medium text-white">Pro</span></a
                  >
                </li>
                <li>
                  <a
          ...
          <li>
            <a
              ...
              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Pages') || (page === 'settings' || page === 'fileManager' || page === 'dataTables' || page === 'pricingTables' || page === 'errorPage' || page === 'mailSuccess') }"
            >
              <svg
                class="fill-current"
                width="18"
    ...
    >
      ...
      <a
        href="../tailadmin.com/pricing.html"
        target="_blank"
        rel="nofollow"
