@if (session('success'))
<div class="flex w-full border-l-6 border-[#34D399] bg-[#34D399] bg-opacity-[15%] px-7 py-2 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30">
    <div class="mr-5 flex h-6 w-full max-w-[36px] items-center justify-center rounded-lg bg-[#34D399]">
...
@if (session('error'))
<div class="flex w-full border-l-6 border-[#F87171] bg-[#F87171] bg-opacity-[15%] px-7 py-2 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30">
    <div class="mr-5 flex h-6 w-full max-w-[36px] items-center justify-center rounded-lg bg-[#F87171]">
...
@if (session('warning'))
<div class="flex w-full border-l-6 border-warning bg-warning bg-opacity-[15%] px-7 py-2 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30">
    <div class="mr-5 flex h-6 w-9 items-center justify-center rounded-lg bg-warning bg-opacity-30">
