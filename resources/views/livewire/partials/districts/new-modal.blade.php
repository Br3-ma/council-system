<div id="newDistrictModal" class="outer-closer">
    <div class="modal-content">
        <div class="w-full flex justify-between items-center">
            <span class="fw-bold font-bold text-primary">
                <h2>New District</h2>
            </span>
            <span onclick="closeModal('newDistrictModal')" class="rounded-full bg-danger text-white p-2">
        ...
        <form wire:submit.prevent="save_district()" class="w-full rounded-sm mb-2 bg-white p-3 dark:border-strokedark dark:bg-boxdark" style="width: 500px" >
            @csrf
            <div class="w-full text-left">
                <div class="relative">
                    ...
                    <input wire:model="name" type="text" class="custom-input-date custom-input-date-1 w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                </div>
                ...
                <div class="relative mt-2">
                    ...
                    <textarea wire:model="map" rows="6" placeholder="Active textarea" class="w-full rounded-lg border-[1.5px] border-primary bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:bg-form-input"></textarea>
                </div>
            </div>
            ...
            <div>
                {{-- <div class="flex gap-2">
                    ...
                    <button class="flex items-center gap-2 rounded bg-warning py-2 px-4.5 font-medium text-white hover:bg-opacity-80">
                    ...
                    <button class="flex items-center gap-2 rounded bg-success py-2 px-4.5 font-medium text-white hover:bg-opacity-80">
