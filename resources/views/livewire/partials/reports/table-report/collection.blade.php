<div class="flex flex-col gap-10 mt-2">
  <div class="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      <div class="max-w-full overflow-x-auto">
          <table id="collections_report" class="w-full table-auto">
              <thead>
              ...
              <tbody>
                  ...
                  @forelse ($transactions as $t)
                      <tr>
                          ...
                          <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                              @php
                                  $transactionCount = $t->transacts->count();
              ...
              <tfoot>
                  <tr>
                      ...
                      <td class="font-bold fs-3">K {{ $grandTotalAmount }}</td>
                      <td class="font-bold fs-3">{{ $grandTotalTransactions }}</td>
                  </tr>
                  <tr>
                    <td></td>
                    <td></td>
