        ...
        <div class="flex flex-col gap-10">
            <div class="rounded-sm bg-white px-5 pt-6 pb-2.5 dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
              ...
              <div class="max-w-full overflow-x-auto">
                <table id="transaction_list_dash" class="w-full table-auto">
                  <thead>
                    <tr class="bg-gray-2 text-left text-sm dark:bg-meta-4">
                  ...
                  <tbody style="overflow: auto;">
                    @forelse ($transactions as $t)
                      <tr>
                        <td class="text-left border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                          <p class="text-black dark:text-white">{{ $t->created_at->toFormattedDateString() }}</p>
                        </td>
                        <td class="text-left border-b border-[#eee] py-5 px-4 dark:border-strokedark">
