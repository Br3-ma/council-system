<div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
    ...
    <div class="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div class="mt-4 flex items-end justify-between">
        <a href="#revenue-streams" onclick="openModal('revenueStreams')">
          <h4 class="text-title-md font-bold text-warning dark:text-white">
            {{ $num_of_transactions_today }}
          </h4>
          <span class="text-sm font-medium">Transactions Today</span>
        </a>
      </div>
    </div>
    ...
    <div class="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div class="mt-4 flex items-end justify-between">
        <a href="#transactions" onclick="openModal('transactionList')">
          ...
          <span class="text-sm font-medium">Total Collections</span>
        </a>
      </div>
    </div>
    ...
    <div class="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div class="mt-4 flex items-end justify-between">
        <a href="#revenue-streams" onclick="openModal('revenueStreams')">
          <h4 class="text-title-md font-bold text-info dark:text-white">
            {{ $num_of_transactions }}
          </h4>
