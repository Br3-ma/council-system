<main>
    ...
    <div class="mx-auto max-w-screen-2xl md:p-6 2xl:p-10">
      ...
      <div class="flex items-center justify-content-between">
        ...
        <form action="{{ route('bulk-receipt-upload') }}" class="items-start w-3/4 md:w-auto mr-4 mb-2" method="post" enctype="multipart/form-data">
          @csrf
          <div class="flex">
        ...
        @endcan
          ...
          <a href="{{ route('export-receipts') }}" class="mt-8 flex items-center  gap-2 rounded bg-secondary py-2 px-3 font-medium text-white hover:bg-opacity-80">
            <span>
