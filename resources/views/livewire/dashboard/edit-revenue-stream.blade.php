...
<body
    ...
    <div class="flex h-screen overflow-hidden">
      <!-- ===== Sidebar Start ===== -->
      @include('layouts.__partials.aside')
        ...
        >
          <span class="hidden text-right lg:block">
            ...
            <span class="block text-xs font-medium">
              {{ ucwords(preg_replace('/[^A-Za-z0-9. -]/', '',  Auth::user()->roles->pluck('name'))) ?? 'Guest' }}  
            </span>
          </span>

          <span class="h-12 w-12 rounded-full">
            <img class="rounded-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYuUISiK3_aAugz2ll1jBnwQuSgBo_QV7vXw&usqp=CAU" alt="User" />
          </span>
    ...
    <div class="mx-auto max-w-screen-2xl md:p-6 2xl:p-10">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <ol class="flex items-center gap-2">
                ...
                <li>
                <a class="font-medium" href="{{ route('streams') }}">Revenue Streams /</a>
                </li>
                <li class="font-medium text-primary">Edit Revenue Streams</li>
            </ol>
        </nav>
        </div>
        @include('livewire.partials.streams.edit-form')
